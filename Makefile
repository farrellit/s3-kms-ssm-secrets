...
publish:
	...
	aws s3 cp --region us-west-2 --profile dodsandbox --acl public-read secrets.linux-amd64 s3://${publish_bucket}/getsecrets/linux/amd64/$$(shasum -a 256 < secrets.linux-amd64 | awk '{print $$1}')/getsecrets
